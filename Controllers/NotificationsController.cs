...
namespace BugTracker.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,RecipientId,SenderId,Title,Messasge,Created,Viewed")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,RecipientId,SenderId,Title,Messasge,Created,Viewed")] Notification notification)
        {
